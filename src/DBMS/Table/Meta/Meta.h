...
struct Meta {
    ...
    Meta() = default;
    Meta (std::string name, CellType dataType, KeyType keyType, bool index, bool nullable);
    Meta (std::string name, CellType dataType, std::string reference, bool index, bool nullable);
